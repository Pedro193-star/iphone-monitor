"""
OLX TRACKER — APPLE WATCH v2
Modelos: SE 2/3, Series 7-11, Ultra 1/2/3
...
FILTROS_DESCRICAO = [
    ...
    r"n[aã]o\s+[eé]\s+original", r"gen[eé]rico", r"1[\s:]*1",
    r"lote\s+de\s+\d+", r"vendo\s+lote",
]

# Prioridade: do mais especifico para o menos
MODELOS_PRIORIDADE = [
    "Apple Watch Ultra 3",
    "Apple Watch Ultra 2",
    "Apple Watch Ultra",
...
PADROES = {
    "Apple Watch Ultra 3":   r"ultra\s*3",
    "Apple Watch Ultra 2":   r"ultra\s*2",
    "Apple Watch Ultra":     r"\bultra\b",
    "Apple Watch Series 11": r"(series|serie|s[eé]rie)\s*11\b|\bs11\b",
    "Apple Watch Series 10": r"(series|serie|s[eé]rie)\s*10\b|\bs10\b",
    "Apple Watch Series 9":  r"(series|serie|s[eé]rie)\s*9\b|\bs9\b",
    "Apple Watch Series 8":  r"(series|serie|s[eé]rie)\s*8\b|\bs8\b",
    "Apple Watch Series 7":  r"(series|serie|s[eé]rie)\s*7\b|\bs7\b",
    "Apple Watch SE 3":      r"se\s*3\b|se[\s\(]*3[\u00aa\s]*gera",
    "Apple Watch SE 2":      r"\bse\b",   # SE sem geracao -> assume SE 2
}
...
# Precos P2P venda rapida (bom estado, GPS base) — CALIBRAR!
PRECOS = {
    "Apple Watch Ultra 3":   {"buy": 530, "sel": 590},
    "Apple Watch Ultra 2":   {"buy": 380, "sel": 430},
    "Apple Watch Ultra":     {"buy": 290, "sel": 330},
    "Apple Watch Series 11": {"buy": 300, "sel": 340},
    "Apple Watch Series 10": {"buy": 225, "sel": 260},
    "Apple Watch Series 9":  {"buy": 170, "sel": 200},
    "Apple Watch Series 8":  {"buy": 130, "sel": 160},
    "Apple Watch Series 7":  {"buy": 105, "sel": 130},
    "Apple Watch SE 3":      {"buy": 160, "sel": 190},
    "Apple Watch SE 2":      {"buy": 95,  "sel": 120},
}
...
def processar_query(nome, query, historico):
    ...
    for anuncio in anuncios:
        ...
        # Nao vale a pena se acima de (venda - 10)
...
def main():
    log("=" * 60)
    log("OLX TRACKER — APPLE WATCH v2 | " + str(RAIO_KM) + "km Oeiras")
...
if __name__ == "__main__":
    main()    "replica", "réplica", "imitacao", "imitação", "copia", "cópia",
    "smartwatch generico", "tipo apple", "estilo apple",
]
